...
<div class="container">
            ...
            <div class="blog-content-left">
                <div class="blog-articals">
                    <div class="blog-artical">
                        <div class="blog-artical-info">
                            <div class="blog-artical-info-img">
                                <a href="single.html"><img src="{{ asset('images/7.jpg') }}" title="post-name"></a>
                            </div>
                            <div class="blog-artical-info-head">
                                <h2><a href="{{ route('single-blog')  }}">
                                        Printing and typesetting industry</a></h2>
                    ...
                    <div class="blog-artical">
                        ...
                        <div class="blog-artical-info">
                            <div class="blog-artical-info-img">
                                <a href="single.html"><img src="http://www.pranxer.com/Images/default-image.jpg" title="post-name"></a>
                                {{--<a href="single.html"><img src="{{ asset('images/8.jpg') }}" title="post-name"></a>--}}
                            ...
                            <div class="blog-artical-info-text">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                    ...
                                    Lorem Ipsum dummy text of the printing and typesetting industry.
                                    Lorem Ipsum has been the industry's standard dummy has been the industry's standard dummy has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.<a href="#">[...]</a></p>
                            </div>
                            <div class="artical-links">
                                <ul>
                                    <li><small> </small><span>june 14, 2013</span></li>
                    ...
                    <div class="blog-artical">
                        ...
                        <div class="blog-artical-info">
                            <div class="blog-artical-info-img">
                                <a href="single.html"><img src="{{ asset('images/9.jpg') }}" title="post-name"></a>
                            </div>
                            <div class="blog-artical-info-head">
    ...
    <div class="footer">
        <div class="col-md-3 foot-1">
            <h4>Quick Links</h4>
            <ul>
                <li><a href="{{route('add-blog')}}">||   Thêm bài viết</a></li>
