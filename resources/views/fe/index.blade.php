...
<!-- Header -->
<header id="header">
    <div class="logo"><a href="{{route('login')}}">Caminar <span>by TEMPLATED</span></a></div>
</header>
...
<section id="main">
    <div class="inner">
        ...
        <section id="two" class="wrapper style2">
            ...
            <div class="content">
                <div class="gallery">
                    <div>
                        <div class="image fit flush">
                            <a href="{{ asset('images/pic03.jpg') }}"><img src="images/pic03.jpg" alt="" /></a>
                        </div>
                    </div>
                    <div>
                        <div class="image fit flush">
                            <a href="{{ asset('images/pic01.jpg') }}"><img src="images/pic01.jpg" alt="" /></a>
                        </div>
                    </div>
                    <div>
                        <div class="image fit flush">
                            <a href="{{ asset('images/pic04.jpg') }}"><img src="images/pic04.jpg" alt="" /></a>
                        </div>
                    </div>
                    <div>
                        <div class="image fit flush">
                            <a href="{{ asset('images/pic05.jpg') }}"><img src="images/pic05.jpg" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="three" class="wrapper">
            <div class="spotlight">
                <div class="image flush"><img src="{{ asset('images/pic06.jpg') }}" alt="" /></div>
                <div class="inner">
            ...
            <div class="spotlight alt">
                <div class="image flush"><img src="{{ asset('images/pic07.jpg') }}" alt="" /></div>
                <div  class="inner">
            ...
            <div class="spotlight">
                <div class="image flush"><img src="{{ asset('images/pic08.jpg') }}" alt="" /></div>
                <div class="inner">
